...
- **送礼物界面**：复用 Creative Agent 的 `gift_panel_template.png`。透明 icon 按原 780×780 画布缩放至 112×112，放在左上空白礼物位中心 `(106, 260)`；名称读取 `community_name`，演示价格固定为 BG71 档位对应的 1000 coins。
